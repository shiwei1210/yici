$(document).ready(function() {
	...
	$(".party-mengceng-no").on("click",function(){
		$(".party-mengceng").css("display","none");
		$(".party-mengceng-box").css("display","none");
...
//选择弹出框（暂不/确定）
function choiceTanchuang(){
	$(".party-mengceng").css("display","block");
	$(".party-mengceng-box").css("display","block");
