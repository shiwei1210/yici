$(function(){
	 ...
	 $(".left").on("click",function(){
	 	var _val = $(".textarea>textarea").val();//输入的内容。
	...
	$(document).on("click",".party-mengceng-yes",function(){
	 	window.location.href= "";
	});
	$(document).on("click",".party-mengceng-no",function(){
		$(".party-mengceng").hide();
	...
	$(".right").on("click",function(){
		var _val = $(".textarea>textarea").val();
